      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(0xFF87CEEB), // Sky blue - سماء صافية
              Color(0xFFB0E0E6), // Powder blue - سماء متوسطة
              Color(0xFFE0F6FF), // Light cyan - أفق بعيد
              Color(0xFFF0F8FF), // Alice blue - أفق قريب
              Color(0xFF98FB98), // Pale green - مروج خضراء
              Color(0xFF90EE90), // Light green - أشجار
              Color(0xFF808080), // Gray - طريق أسفلت
            ],
        ...
        child: Stack(
          children: [
            // خلفية مع عناصر بصرية للباص المدرسي
            Positioned(
              top: 50,
              right: 20,
              child: Opacity(
